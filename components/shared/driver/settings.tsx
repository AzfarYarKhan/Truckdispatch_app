...
import Loadingspinner from "@/components/shared/driver/settingformloading";
import { updateDriver } from "@/app/actions/user.actions";
...
export default function Setting({ currentUser, currentDriver }: SettingProps) {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      company: currentDriver?.company ? currentDriver.company : "",
      address: currentDriver?.address ? currentDriver.address : "",
      phone: currentDriver?.phone_number ? currentDriver.phone_number : "",
    },
  });
  const handleImage = (
